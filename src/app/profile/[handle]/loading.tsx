...
function SkeletonSkillCard() {
  return (
    <article className="border border-dawn-2 bg-white p-2.5">
      ...
      <div className="mt-3 flex items-center justify-between gap-2 border-t border-dawn-2 pt-2">
...
function SkeletonHypothesisCard() {
  return (
    <article className="border border-dawn-2 bg-white p-3">
...
export default function ProfileLoading() {
  return (
    <div className="relative overflow-hidden" aria-busy="true" aria-live="polite">
      <WaveHeader />
      <main className="relative z-20 -mt-6 w-full bg-day-1 px-2 pb-6">
              ...
              <section className="grid items-start gap-2 lg:grid-cols-[430px_minmax(0,1fr)] xl:grid-cols-[446px_minmax(0,1fr)]">
                    ...
                    <div className="flex h-full flex-col gap-6">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        {Array.from({ length: 4 }).map((_, idx) => (
                          <div key={idx} className="flex h-[90px] flex-col gap-2 border border-dawn-2 bg-white p-3">
                ...
                <section className="size-full rounded-section border border-dawn-2 bg-white p-3">
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="border border-dawn-2 bg-white p-3">
                      <SkeletonLine className="h-5 w-36" />
                      <SkeletonLine className="mt-2 h-3 w-full" />
